...
from utils.misc.allmethods import ask_contact, send_error, send_personal_message, send_corporate_message, \
    ...
    send_contact_us, send_error_choice
...
async def main_menu_handler(message):
    ...
    #
    #             send_dynamic_btns(message.chat.id, user.lang, children, body)
    #             bot.set_state(message.chat.id, UserState.child)
